...
public class LoginDBController implements Initializable, Observable {
    ...
    public MFXTextField databaseText;
    ...
    public MFXComboBox<String> databasesCB;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        databasesCB.setItems(FXCollections.observableArrayList(R.array.databases));
    ...
    public void login(ActionEvent actionEvent) throws Exception {
        try{
            ...
            Active.user = loginViewModel.login(username, passwordText.getText(), hostText.getText(), Integer.parseInt(portText.getText()), connectionType, databaseText.getText());
    ...
    public void loadVIewData(User user){
        ...
        databaseText.setText(user.getDb());
    }
    @FXML
